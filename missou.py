...
##
##Now we have geocoded addresses, and we're ready to get started on our perp db
#        print "Attemping insert"
        perpdb.execute('insert into perp values (?,?,?,?,?,?,?,?,?,?,?,?,?)', [line[0], line[2], line[3], line[4], line[5], line[6], line[7], line[8], line[9], shortaddy, fulladdy, glat, glong])
#        perpdbconn.commit()
        print line[0], line[2], line[3], line[4], line[5], line[6], line[7], line[8], line[9], shortaddy, fulladdy, glat, glong
#        print "   perpdb.execute('insert into perp values (?,?,?,?,?,?,?,?,?,?,?,?,?)', [line[0], line[2], line[3], line[4], line[5], line[6], line[7], line[8], line[9], shortaddy, fulladdy, glat, glong])"
